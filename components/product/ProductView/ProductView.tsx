                    ...
                    return (
                      <Tab title={tabItem.title}>
                        ...
                        <div className={s.tabContentWrapper}>
                            ...
                            <>
                                      ...
                                      {tabItem.left?.items &&
                                        tabItem.left.items.map((item: any) => {
                                          return (
                                            <div
                                              className={
                                                s.tabListContentItemWrapper
                                              }
                                            >
                                              <div
                                                className={s.tabListContentItem}
                                              >
                                                <p>{item?.main}</p>
                                              </div>
                                              <div
                                                className={
                                                  s.tabListContentItemSub
                                                }
                                              >
                                                {item.sub}
                                              </div>
                              ...
                              <div className="block md:hidden text-center">
                                ...
                                <div className={s.tabListContentMobile}>
                                  <div className={s.leftTab}>
                                    <h3
                                      className={`${s.tabListContentTitle} mb-12`}
                                    >
                                      {tabItem.left?.title}
                                    </h3>
                                    <div className={s.tabListContentItems}>
                                  ...
                                  <div className={s.rightTab}>
                                    <h3
                                      className={`${s.tabListContentTitle} mb-4`}
                                    >
                                      {tabItem.right?.title}
                                    </h3>
                                    <div className={s.tabListContentItems}>
                                  ...
                                  >
                                    <div
                                      className={`${s.arrow} w-2 relative h-full`}
                                    />
                                  </div>
                                </div>
                              </div>
                          ...
                          {tabItem.items ? (
                            <>
                              <ProductDetailSlider content={tabItem.items} />
                              <hr className="my-6" />
                              <div className="flex justify-between">
                                {tabItem.subItems.map((subItem: string) => (
